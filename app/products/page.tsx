...
function ProductContent(){
 ...
 if(!key)return <AppShell title="商品詳細" description=""><div className="table-message"><p>商品が指定されていません。一覧で商品を選ぶと価格履歴を確認できます。</p><Link className="tool-button primary" href="/opportunities">該当商品から選ぶ</Link></div></AppShell>;
