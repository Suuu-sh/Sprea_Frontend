...
export default function Home(){
 ...
 return <AppShell capital={portfolio.initialCapital} title="案件リサーチ" description="本番基盤上のMock Collectorデータで、検出・判定・資金配分の一連の流れを確認します。" badge="PRODUCTION / MOCK DATA" actions={<button className="tool-button" aria-label="更新" onClick={load}><RefreshCw size={16}/></button>}>
