...
export default function Home(){
 ...
 return <AppShell capital={portfolio.initialCapital} title="案件リサーチ" description="承認済みの本番データだけで、検出・判定・資金配分を行います。" badge="PRODUCTION DATA" actions={<button className="tool-button" aria-label="更新" onClick={load}><RefreshCw size={16}/></button>}>
